...
class Header extends Component {
  ...
  render() {
    ...
    <h1 className="text-center lg:text-left mr-2 text-[25px]  float-left max-sm:hidden max-md:hidden max-xl:hidden">
            A Deep Dive Into The Gaming Virtual World<br/>
            Create your own space in the gaming world
          </h1>
          <div className="hidden lg:block text-center">
            <img
              src="./space-baby.png"
              className="h-[650px] mx-auto mt-[-1rem] ml-[360px]"
              alt=""
            />
          </div>
        ...
        <div className="lg:hidden text-center">
            <h1 className="text-[25px] mt-4">A Deep Dive Into The Gaming Virtual World</h1>
            <p className="text-[15px]">Create your own space in the gaming world</p>
          </div>
